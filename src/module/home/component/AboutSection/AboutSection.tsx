  ...
  return (
    ...
    >
      <div className={s.inner}>
        ...
        <p className={s.text}>
          <span className={s.festivalName}>{FESTIVAL.name}</span> — це фестиваль{' '}
          <em className={s.accent}>ведичної культури</em>, який є частиною
          міжнародного проєкту Vedalife. Понад{' '}
          <em className={s.accent}>15 років</em> проєкт поєднує людей у різних
          країнах світу та популяризує здоровий спосіб життя, саморозвиток,
          творчість і життя в гармонії з природою.
        </p>

        <p className={s.text}>
          Протягом двох днів на вас чекають <em className={s.accent}>йога</em>,{' '}
          <em className={s.accent}>лекції</em>,{' '}
          <em className={s.accent}>майстер-класи</em>, оздоровчі практики,{' '}
          <em className={s.accent}>музичні виступи</em>,{' '}
          <em className={s.accent}>ярмарок</em>, екскурсії, смачна
          вегетаріанська кухня, сферичний кінотеатр, артпростір та багато інших
          цікавих подій <em className={s.accent}>для всієї родини</em>.
        </p>
